...
>
> **Update (2026-06-08, Stantu):** in raid ora si gioca **Slayer** (ha Rend + Whirlwind + Bladestorm); l'M+ resta **Mountain Thane** (Thunder Clap, niente Rend/Bladestorm). La macro cleave `rend-whirlwind` discrimina su `known:Thunder Clap`: raid Slayer (no TC) → castsequence `Rend, Whirlwind`; M+ MT (TC) → Thunder Clap singolo.
