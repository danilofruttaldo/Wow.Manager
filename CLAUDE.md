...
- **`brf-lfr` non ha dati e non è un errore**: nel client Blackrock Foundry espone solo Normal/Heroic/Mythic, nessun set Raid Finder — a differenza di Hellfire Citadel che li ha tutti e quattro. Da chiarire se quel set LFR esista davvero prima di togliere o tenere la riga.
