...
- **Boss nel tooltip: copertura parziale (78%),** cioè quante voci di `pieceList` hanno un boss fra parentesi (6249 su 8009). Per espansione: WoD/Legion 98%, MoP 97%, SL 84%, TWW 78%, Midnight 77%, DF 75%, Cata 65%, Classic 52%, WotLK 43%, TBC 34%. Senza boss noto la voce resta il solo slot: **non inventarlo**.
